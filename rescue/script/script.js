...
function ans2() {
    heading.style.display = "block";
    answer.textContent = "You cannot tell if an animal has rabies simply by seeing it. A test must be performed to tell if an animal has rabies. Do not approach wildlife that you suspect might be rabid. Contact us to have the animal removed.";
}

// function to display 3rd answer
function ans3() {
    heading.style.display = "block";
...
//function to display 4th answer
function ans4() {
    heading.style.display = "block";
